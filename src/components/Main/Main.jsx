    ...
    <div className="flex-1 relative min-h-screen pb-[15vh]">
      ...
      <div className="max-w-4xl m-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 p-5">
          <div className="relative card h-48 p-4 rounded-lg cursor-pointe bg-gray-100 hover:bg-gray-300">
        ...
        <div className="absolute w-full bottom-8 md:bottom-20 max-w-4xl m-auto px-5">
          <div className="py-1 md:py-2 px-2 md:px-5 flex items-center justify-between gap-5 bg-gray-100 rounded-full">
            <input
              type="text"
